...
from test.golden.introspection import (
    gen_introspection_watches_tick,
    gen_introspection_watches_inst,
)
...
def machine_testbench(
    ...
    tick_tracer = TraceTick(clk, tick_trace_data, gen_introspection_watches_tick(intro))

    inst_tracer = TraceInstr(
        clk,
        inst_trace_data,
        gen_introspection_watches_inst(intro),
        intro.control.seq.mc_pc,
