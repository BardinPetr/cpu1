...
stdlib["key"] = [gen_push(STDIN_REG), *stdlib["io@"].code]

# io out
stdlib["io!"] = [Instr(Opcode.OUT)]
stdlib["."] = [gen_push(STDOUT_INT_REG), *stdlib["io!"].code]
stdlib["emit"] = [gen_push(STDOUT_CHAR_REG), *stdlib["io!"].code]
stdlib["cr"] = [gen_push(ord("\n")), *stdlib["emit"].code]
